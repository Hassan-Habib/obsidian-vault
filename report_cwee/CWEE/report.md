...
## Web Application Security Assessment Summary <a id="web-application-security-assessment-summary"></a>
...
### SQL Injection at https://www.royalflush.htb/forgot <a id="f7111d6e-f236-41a6-8604-e248aea5426c"></a>
...
### Leaked AUTH_SECRET → cookie forgery <a id="2f5bc430-0879-431e-89a9-4e66141b48f2"></a>
...
### Role-upgrade bypass via parameter logic flaw (fookey) <a id="ef542905-12d7-4c90-890a-b95396542be5"></a>
...
### No domain restriction at registration <a id="009c6a45-40b2-44ee-8c6b-769c061549e0"></a>
...
### NoSQL Injection at verify-email endpoint forum.royalflush.htb <a id="b5ce6c43-ed46-4f81-8e44-30a5e758daae"></a>
...
### Creds Leak at forum.royalflush.htb <a id="11975b2f-d6df-4f75-989c-19dd279e2467"></a>
...
### SQL Injection at Vault.royalflush.htb <a id="3d54335f-b7d9-4631-b09e-78cdc0d306a8"></a>
...
### .NET BinaryFormatter deserialization <a id="0038712a-c54f-41b6-bad2-da0c98d68114"></a>
...
### LDAP injection at ldap.vitamedix.htb <a id="6bfa3977-88f0-4c2c-91d3-978ce8913206"></a>
...
### Valid email enumeration via forgot-password self-service (michael@vitamedix.htb) <a id="5296e7d1-3552-4af2-8303-4f39f503ee54"></a>
...
### Logic Flaw on Storage.vitamedix.htb → SMTP credentials leak <a id="a5772f07-ca79-4f30-9424-51762dbe1fc8"></a>
...
### Email header injection (CRLF) in password reset <a id="d344076c-001e-4d19-acab-ec9e495fab71"></a>
...
### DNS.vitamedix:8006 Pi-hole password leak (WEBPASSWORD: pih***) <a id="0f92f352-828c-4b46-b853-6592beec8b3d"></a>
...
### NoSQL Injection in /api/validateToken www.vitamedix.htb <a id="aaa9d649-31b9-4592-992d-51182c427f73"></a>
...
### DNS rebind => CSRF => Stored Cross-Site Scripting (XSS) => Admin cookie theft <a id="edb020c8-9ce8-4b17-9b9e-5f074ae0f552"></a>
...
### PDF generation SSRF via DNS rebinder → internal CouchDB access <a id="b7b812b2-8457-49f0-8f78-f9935efd02e2"></a>
...
### RCE via eval on newsletter.vitamedix.htb <a id="1f15992e-d5b7-4d4a-8b5c-598cdb328a95"></a>
...
### XPath injection in q parameter at query.php&home.php <a id="35596b72-d4e0-4ea3-ba1a-5c6dd5d924e0"></a>
...
### Race condition on admin_panel.php <a id="2b749d43-75e4-4608-ba24-404b1cadbaae"></a>
...
### request smuggling Attack at securedata.htb <a id="95cec507-bee6-491d-9043-837dbecdff63"></a>
...
### XSS in http://securedata.htb/admin/admin_panel.php in CLIENT-IP header via Cache-poisoning  <a id="9d9448f8-0a56-4e7d-ab86-82a1e6410844"></a>
...
### Remote Code Execution in http://api.securedata.htb/service_status?service=nginx <a id="d80d28b1-7608-40ff-a635-4a64c7c47b08"></a>
...
### Finding Severities <a id="finding-severities"></a>
...
### Testing Methodology <a id="testing-methodology"></a>
...
### Flags Discovered <a id="flags-discovered"></a>
